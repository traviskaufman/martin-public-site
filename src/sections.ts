export const sections = [
  {
    id: "i-clarify-by-default",
    title: "I clarify by default",
    sentence:
    ...
    comparisons: ["clarifying-questions"],
  },
  {
    id: "i-make-minimal-assumptions",
    title: "I make minimal assumptions",
    sentence:
      "I will never go off and build a 40-file change you never asked for. I step back, reason, and plan before I touch code.",
    comparisons: ["problem-understanding"],
  },
  {
    id: "zero-slop",
    title: "Zero slop",
    ...
    comparisons: ["code-quality", "testing-and-robustness"],
  },
] as const;
